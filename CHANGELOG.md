...
- Fix `ed25519verify` opcode implementation. Previosuly the signature was only checked against the data not the concatanation of "ProgData"||program||data. Additionally test scenarios was added to check the correct implementation. 
