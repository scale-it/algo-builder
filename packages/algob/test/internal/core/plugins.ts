...
import { loadPluginFile, readPackageJson, usePlugin } from "../../../src/internal/core/plugins";
...
describe("plugin system", function () {
	...
	describe("loadPluginFile", function () {
		...
		it("Should work when the plugin exports a function", function () {
			loadPluginFile(
				path.join(FIXTURE_PROJECT_PATH, "node_modules", "pack1", "plugin-with-function.js")
			);
		...
		it("Should work when the plugin doesn't export a function", function () {
			loadPluginFile(
				path.join(FIXTURE_PROJECT_PATH, "node_modules", "pack1", "plugin-without-function.js")
			);
	...
	describe("loadPluginFile", function () {
		const globalAsAny = global as any;
		const projectPath = path.join(FIXTURE_PROJECT_PATH, "doesnt-need-to-exist-config.js");
