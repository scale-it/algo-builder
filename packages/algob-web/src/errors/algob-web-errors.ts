...
import { ErrorDescriptor, getAlgobWebErrorCode } from "./errors-list";

export class AlgobWebError extends Error {
  public static isAlgobWebError(other: any): other is AlgobWebError { // eslint-disable-line
    return (
      other !== undefined && other !== null && other._isAlgobWebError === true
    );
  }
  ...
  private readonly _isAlgobWebError: boolean;
  ...
  constructor (
    ...
    const prefix = `${getAlgobWebErrorCode(errorDescriptor)}: `;
    ...
    this._isAlgobWebError = true;
    Object.setPrototypeOf(this, AlgobWebError.prototype);
  }
}
