...
export class Pragma extends Op {
  ...
  constructor (args: string[], line: number, interpreter: Interpreter) {
    ...
    if (args[0] === "version" && (args[1] === '1' || args[1] === '2')) {
      ...
      throw new TealError(TEAL_ERRORS.TEAL.PRAGMA_VERSION_ERROR, { got: args.join(' '), line: line });
    }
  }
...
export class Div extends Op {
  ...
  execute (stack: TEALStack): void {
    ...
    const prev = this.assertBigInt(stack.pop(), this.line);
    if (last === BIGINT0) {
      throw new TealError(TEAL_ERRORS.TEAL.ZERO_DIV, { line: this.line });
    }
...
export class Err extends Op {
  ...
  execute (stack: TEALStack): void {
    throw new TealError(TEAL_ERRORS.TEAL.TEAL_ENCOUNTERED_ERR, { line: this.line });
  }
}
...
export class EqualTo extends Op {
  ...
  execute (stack: TEALStack): void {
    ...
    if (typeof last !== typeof prev) {
      throw new TealError(TEAL_ERRORS.TEAL.INVALID_TYPE, { line: this.line });
    }
...
export class Btoi extends Op {
  ...
  execute (stack: TEALStack): void {
    ...
    if (bytes.length > 8) {
      throw new TealError(TEAL_ERRORS.TEAL.LONG_INPUT_ERROR, { line: this.line });
    }
...
export class Concat extends Op {
  ...
  execute (stack: TEALStack): void {
    ...
    if (valueA.length + valueB.length > MAX_CONCAT_SIZE) {
      throw new TealError(TEAL_ERRORS.TEAL.CONCAT_ERROR, { line: this.line });
    }
  ...
  execute (stack: TEALStack): void {
    ...
    switch (this.field) {
      ...
      case "AssetFrozen":
        ...
        break;
      default:
        throw new TealError(TEAL_ERRORS.TEAL.INVALID_FIELD_TYPE, { line: this.line });
    }
...
export class GetAssetDef extends Op {
  ...
  constructor (args: string[], line: number, interpreter: Interpreter) {
    ...
    if (AssetParamMap[args[0]] === undefined) {
      throw new TealError(TEAL_ERRORS.TEAL.UNKNOWN_ASSET_FIELD, { field: args[0], line: line });
    }
...
export class Addr extends Op {
  ...
  constructor (args: string[], line: number) {
    ...
    if (!isValidAddress(args[0])) {
      throw new TealError(TEAL_ERRORS.TEAL.INVALID_ADDR, { addr: args[0], line: line });
    }
    this.addr = args[0];
    this.line = line;
  };
