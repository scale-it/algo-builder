import type { TxParams } from "algob/src/types";
 ...
 * parsing teal code
 * @param {TxParams} txnParams : Transaction parameters for current txn
 ...
 */
export function execute (txnParams: TxParams, logic: Logic[], args: AppArgs): boolean {
