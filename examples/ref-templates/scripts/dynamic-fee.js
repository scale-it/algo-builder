...
async function run(runtimeEnv, deployer) {
  ...
  let transactions = [
    mkTxnParams(masterAccount, escrow, 1000, signedContract, {totalFee: 500}),
    mkTxnParams({ addr: escrow}, john.addr, 700000, contract, { totalFee: 500, closeRemainderTo: bob.addr })]
  ...
  transactions = [
    mkTxnParams(masterAccount, escrow, 1000, signedContract, {totalFee: 500}),
    mkTxnParams({ addr: escrow}, john.addr, 700000, contract, { totalFee: 500, closeRemainderTo: masterAccount.addr })]
