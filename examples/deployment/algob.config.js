...
let accounts = mkAccounts([
  {
    ...
    // It must already exist or ALGO have to be transferred from elsewhere.
    ...
    // To export private mnemonic you must use this command (with you own account's address and data directory)
  ...
  // Do not use them in your own applications.
  {
