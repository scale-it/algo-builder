...
async function run(runtimeEnv, deployer) {
  ...
  */
  ...
  const [mparams, kmdMsigAddress] = createMsigAddress(1, 2, addrs);   // passing (version, threshold, address list)
  ...
  await transferMicroAlgos(deployer, masterAccount, kmdMsigAddress, 10000000, {note: "Funding multisig account"});
