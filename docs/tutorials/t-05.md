...
You can create a wallet widget to connect to different wallets using our `Wallet Widget`. To add it, follow the steps mentioned in this [tutorial](https://developer.algorand.org/solutions/vuejs-multi-wallet-widget/)
...
3. Wallet Connect<br/>
   Perra Wallet currently doesn't support Multisignature transaction signature, thus it's support will be added after Perra supports it.
