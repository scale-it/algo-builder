...
The purpose of this tutorial is the demonstrate the usage of Algo Builder Web Package to sign a Multisignature Transaction using major Algorand wallets (Algo Signer, Wallet Connect, MyAlgoWallet).
...
You can create a wallet widget to connect to different wallets using our `Wallet Widget`. To add it, follow the steps mentioned in this [tutorial]()

### MultiSignature Transaction

To create a msig transaction, you can follow steps from the offical docs of Algorand Foundation to create a [Multisignature address](https://developer.algorand.org/docs/get-details/accounts/create/#multisignature) and [Transaction](https://developer.algorand.org/docs/sdks/javascript/) using it.
Here is a glimpse of the creating the multisig transaction:
...
<img src="./t-05/assets/algosigner.png" height="200" title="Sign Msig Txn" />
...
The response includes the confirmed transaction response along with txID.

2. MyAlgo Wallet
   We use `connectMyAlgoWallet()` method is used to connect the My Algo wallet.
...
The following screens will popup for you to login to msig and sign the txn:
<img src="./t-05/assets/myalgo-1.png" height="200" title="Unlock msig" />
<img src="./t-05/assets/myalgo-2.png" height="200" title="Sign Msig Txn" />
<img src="./t-05/assets/myalgo-3.png" height="200" title="Pending confirmation" />

The response is the object containing blob key.
...
Here also the response includes the confirmed transaction response along with txID.

3. Wallet Connect
   Perra Wallet currently doesn't support signing the Multisignature transaction, thus it support will be added whenever Perra supports it.
